    ...
    <div class="px-4 sm:px-6 lg:px-8">
        <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
                <h1 class="text-base font-semibold leading-6 text-gray-900">Заказы</h1>
                <p class="mt-2 text-sm text-gray-700">
                    Для более быстрой навигации, используйте кнопки выбора типа заказа.
                </p>
            </div>

        </div>
        <div class="mt-8 flow-root" v-if="orders != null">
        ...
        <div class="mt-4" v-if="orders != null">
    ...
    methods: {
        getUsers() {
            axios.get('/sanctum/csrf-cookie').then(() => {
                axios.get(route("getOrders", {'page': this.page})).then(r => {
